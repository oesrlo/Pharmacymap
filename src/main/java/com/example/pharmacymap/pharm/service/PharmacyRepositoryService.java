package com.example.pharmacymap.pharm.service;

import com.example.pharmacymap.pharm.entity.Pharmacy;
import com.example.pharmacymap.pharm.repository.PharmacyRepository;
...
public class PharmacyRepositoryService {
    ...
    public void updateAddress(Long id, String address) {
        ...
        entity.changePharmacyAddress(address);// 정상일 경우
    }

    // for test not transaction ( 더티체킹 일어나는지 아닌지 확인)
